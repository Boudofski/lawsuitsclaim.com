---
title: "Claim ID vs Confirmation Code: What Is the Difference?"
seoTitle: "Claim ID vs Confirmation Code in a Class Action Settlement"
metaDescription: "Settlement notices often include a Claim ID or Notice ID. Learn what these numbers mean, how to use them, and what a confirmation code indicates."
slug: "claim-id-vs-confirmation-code"
primaryKeyword: "claim ID settlement notice"
secondaryKeywords: ["settlement notice ID number", "confirmation code class action", "what is claim ID"]
publishedAt: "2026-06-04"
excerpt: "Settlement notices often include identification numbers. Understanding the difference between a Claim ID, Notice ID, and confirmation code helps you use them correctly."
schema: "Article"
featured: false
---
